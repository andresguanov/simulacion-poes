    ...
    return (
        <div>
            ...
            <div>
                ...
                <input type="number" name="iFrom" id="iFrom" min={0} required />
            </div>

            <div>
                <label htmlFor="jFrom">Posición j inicial: </label>
                <input type="number" name="jFrom" id="jFrom" min={0} required />
            </div>

            <div>
                <label htmlFor="kFrom">Posición k inicial: </label>
                <input type="number" name="kFrom" id="kFrom" min={0} required />
            </div>

            <div>
                <label htmlFor="iTo">Posición i final: </label>
                <input type="number" name="iTo" id="iTo" min={0} required />
            </div>

            <div>
                <label htmlFor="jTo">Posición j final: </label>
                <input type="number" name="jTo" id="jTo" min={0} required />
            </div>

            <div>
                <label htmlFor="kTo">Posición k final: </label>
                <input type="number" name="kTo" id="kTo" min={0} required />
            </div>

            <div>
                <label htmlFor="porosity">Porosidad específica del sector: </label>
                <input type="number" name="porosity" id="porosity" step="any" min={0} required />
            </div>

            <div>
                <label htmlFor="sw">Sw específica del sector: </label>
                <input type="number" name="sw" id="sw" step="any" min={0} required />
            </div>

            <div>
                <label htmlFor="boi">Boi específico del sector: </label>
                <input type="number" name="boi" id="boi" step="any" min={0} required />
            </div>
